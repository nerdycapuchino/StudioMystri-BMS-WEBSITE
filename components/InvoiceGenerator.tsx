...
export const InvoiceGenerator: React.FC = () => {
  const { addInvoice, formatCurrency } = useGlobal();
  ...
  return (
    <div className="h-full flex flex-col md:flex-row bg-black overflow-hidden">
        ...
        <div className="w-full md:w-1/2 bg-zinc-900 overflow-y-auto p-8 flex items-start justify-center">
            <div className="bg-white text-black w-[210mm] min-h-[297mm] shadow-2xl p-[10mm] text-xs font-sans leading-tight relative print:w-full print:h-full print:fixed print:inset-0 print:m-0">
